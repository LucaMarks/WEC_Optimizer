...
public class TileManager {
    ...
    public ArrayList<Tile> resources;
    public ArrayList<Tile> pois;
    public ArrayList<Tile> life;
    public ArrayList<Tile> hazards;
    public ArrayList<Tile> currents;
    public ArrayList<Tile> corals;
    public ArrayList<Tile> cells;
